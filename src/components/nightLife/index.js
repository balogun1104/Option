...
import Collection from "../commonCodes/collection";
import ExploreSection from "../commonCodes/exploreSection";
import Filters from "../commonCodes/filters";
  ...
  return (
    <div>
      ...
      <ExploreSection
        ...
        collectionName="Nightlife Restaurants in Lagos"
      />
    </div>
  );
};
